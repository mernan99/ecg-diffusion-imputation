...
- [Methods](#methods)
  - [Interpolation Baselines](#1-interpolation-baselines)
  - [Basic Autoencoder](#2-basic-autoencoder)
  - [Morphology-Aware 1D U-Net](#3-morphology-aware-1d-u-net)
  - [Conditional Diffusion Model](#4-conditional-diffusion-model)
  - [Predictive Uncertainty](#5-predictive-uncertainty)
  - [PCE and Sobol Sensitivity Analysis](#6-pce-and-sobol-sensitivity-analysis)
  - [Paired Statistical Analysis](#7-paired-statistical-analysis)
...
- [Results](#results)
- [Uncertainty Quantification Results](#uncertainty-quantification-results)
...
| Factor | First-order \(S_1\) | Total-effect \(S_T\) |
|---|---:|---:|
